...
#[derive(OpenApi)]
#[openapi(
    paths(super::global::search_global_logs, search_logs, get_log_context, tail_logs, purge_project_logs),
    components(
        schemas(
