...
#[derive(Debug, Clone, Serialize)]
pub struct ComposeSourceSavedAudit {
    pub context: AuditContext,
    pub project_id: i32,
    pub source_bundle_id: i32,
}
...
#[derive(Debug, Clone, Serialize)]
pub struct DeployFromComposeSourceAudit {
    pub context: AuditContext,
    pub project_id: i32,
    pub environment_id: i32,
    pub deployment_id: i32,
...
impl_audit_operation!(ComposeSourceSavedAudit, "COMPOSE_SOURCE_SAVED");
impl_audit_operation!(DeployFromComposeSourceAudit, "DEPLOY_FROM_COMPOSE_SOURCE");
