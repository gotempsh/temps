...
pub fn generate_generic_webhook_token() -> Result<String, rand::rngs::SysError> {
...
mod tests {
    ...
    fn test_generate_generic_webhook_token_is_64_hex_chars() {
        let tok = generate_generic_webhook_token().unwrap();
    ...
    fn test_generate_generic_webhook_token_is_unique() {
        let t1 = generate_generic_webhook_token().unwrap();
        let t2 = generate_generic_webhook_token().unwrap();
