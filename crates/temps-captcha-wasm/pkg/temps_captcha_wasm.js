...
/* @ts-self-types="./temps_captcha_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function solve_challenge(challenge, difficulty, callback) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(challenge, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.solve_challenge(ptr0, len0, difficulty, callback);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {boolean}
 */
export function verify_solution(challenge, nonce, difficulty) {
    const ptr0 = passStringToWasm0(challenge, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(nonce, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.verify_solution(ptr0, len0, ptr1, len1, difficulty);
    return ret !== 0;
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./temps_captcha_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('temps_captcha_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
