...
<picture>
  ...
  <img alt="Crie um novo projeto no Temps — importe um repositório, comece a partir de um template, clone uma URL Git ou faça deploy de uma imagem Docker" src="assets/screenshots/create-light.png">
</picture>
