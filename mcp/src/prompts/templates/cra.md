## Adding Analytics to Create React App

Follow these steps to integrate Temps analytics into your Create React App application:
...
Wrap your app with the provider in `index.js` or `index.tsx`:
