...
export function AddRoute() {
  ...
  const watchedRouteType = useWatch({
    control: form.control,
    name: 'routeType',
  })
  const watchedDomainInputType = useWatch({
    control: form.control,
          ...
          >
            ...
            <Card>
              <div className="p-6 space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Choose how incoming traffic should be matched and routed to
                  your backend.
                </p>
                            ...
                            <label className="flex cursor-pointer flex-col p-4">
                              <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 space-y-2">
                                  ...
                                  <p className="text-sm text-muted-foreground">
                                    Routes traffic based on the HTTP Host
                                    header. Works for both HTTP and HTTPS after
                                    TLS termination.
                                  </p>
                                  <div className="space-y-1 text-sm pt-2">
                                    ...
                                    <div className="flex items-center gap-2 text-muted-foreground">
                                      ...
                                      <span>
                                        Full HTTP inspection & modification
                                      </span>
                                    </div>
                                    <div className="flex items-center gap-2 text-muted-foreground">
                            ...
                            <label className="flex cursor-pointer flex-col p-4">
                              <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 space-y-2">
                                  ...
                                  <p className="text-sm text-muted-foreground">
                                    Routes traffic based on TLS SNI (Server Name
                                    Indication) hostname. Traffic is passed
                ...
                {watchedRouteType === 'tls' && (
                  <Alert>
                    ...
                    <AlertDescription>
                      <strong>TLS/SNI routing</strong> passes encrypted traffic
                      directly to your backend without terminating TLS. Your
                      backend service must handle its own SSL certificates. This
                      is useful for services that require end-to-end encryption
                      or have their own certificate management.
                    </AlertDescription>
                  </Alert>
                )}
              </div>
            ...
            <Card>
              <div className="p-6 space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Specify the domain that will be routed to your backend
                  service.
                </p>
                  ...
                  <AlertDescription>
                    <div className="space-y-2">
                      ...
                      {watchedRouteType === 'http' && (
                        <p className="text-xs">
                          Using HTTP routing: TLS will be terminated at the
                          proxy and traffic forwarded to your backend over HTTP.
                        </p>
                      )}
                      {watchedRouteType === 'tls' && (
                        <p className="text-xs">
                          Using TLS passthrough: Encrypted traffic will be
                          forwarded directly to your backend. Ensure your
                          backend handles TLS.
                        </p>
                      )}
                    </div>
