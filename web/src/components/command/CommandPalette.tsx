...
const settingsNavItems: NavigationItem[] = [
  ...
  },
  {
    ...
    url: '/dns-providers',
    icon: GlobeLock,
    keywords: ['dns', 'cloudflare', 'route53', 'azure', 'gcp', 'digitalocean', 'namecheap'],
  },
  {
    title: 'Add DNS Provider',
    url: '/dns-providers/add',
    icon: GlobeLock,
    keywords: ['dns', 'add', 'new', 'cloudflare', 'route53', 'azure', 'gcp', 'digitalocean'],
  },
  {
    title: 'Notifications',
    url: '/notifications',
  ...
  },
  {
    ...
    icon: BellPlus,
    keywords: ['notifications', 'add', 'new', 'slack', 'email', 'webhook', 'alerts'],
  },
  {
    title: 'Backups',
    url: '/backups',
