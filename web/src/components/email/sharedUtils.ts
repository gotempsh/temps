...
// AWS regions offered for SES providers
...
// Scaleway regions offered for Transactional Email providers
export const scalewayRegions = [
  { value: 'fr-par', label: 'Paris, France' },
  { value: 'nl-ams', label: 'Amsterdam, Netherlands' },
  { value: 'pl-waw', label: 'Warsaw, Poland' },
]

export function providerTypeLabel(type: 'ses' | 'scaleway' | 'smtp'): string {
  switch (type) {
    case 'ses':
      return 'AWS SES'
    case 'scaleway':
