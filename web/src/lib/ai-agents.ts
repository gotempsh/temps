...
export const AI_PROVIDERS: { provider: string; agents: string[] }[] = [
  ...
  { provider: 'Google', agents: ['GoogleOther', 'Googlebot', 'Gemini-Deep-Research'] },
  { provider: 'Microsoft', agents: ['Bingbot'] },
  ...
  { provider: 'DeepSeek', agents: ['DeepSeekBot'] },
  ...
  { provider: 'xAI', agents: ['GrokBot', 'xAI-Grok'] },
]
