 ...
 */
export const getUnifiedTraceOptions = (options: Options<GetUnifiedTraceData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const getCrossProjectTraceSiblingsOptions = (options: Options<GetCrossProjectTraceSiblingsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
