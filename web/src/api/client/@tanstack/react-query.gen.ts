...
import { type Options, getPlatformInfo, recordEventMetrics, addSessionReplayEvents, initSessionReplay, recordSpeedMetrics, updateSpeedMetrics, getActiveVisitors, getEventsCount, getGeneralStats, getPageHourlySessions, getPagePaths, getSessionDetails, getSessionEvents, getSessionLogs, getVisitors, getVisitorByGuid, getVisitorById, getVisitorDetails, enrichVisitor, getVisitorInfo, getVisitorSessions, getVisitorStats, listApiKeys, createApiKey, getApiKeyPermissions, deleteApiKey, getApiKey, updateApiKey, activateApiKey, deactivateApiKey, getDeploymentJobLogs, ingestSentryEnvelope, ingestSentryEvent, emailStatus, login, requestMagicLink, verifyMagicLink, requestPasswordReset, resetPassword, verifyEmail, verifyMfaChallenge, listS3Sources, createS3Source, deleteS3Source, getS3Source, updateS3Source, listSourceBackups, runBackupForSource, listBackupSchedules, createBackupSchedule, deleteBackupSchedule, getBackupSchedule, listBackupsForSchedule, disableBackupSchedule, enableBackupSchedule, getBackup, lookupDnsARecords, listDomains, createDomain, getDomainByHost, cancelDomainOrder, getDomainOrder, createOrRecreateOrder, finalizeOrder, deleteDomain, getDomainById, getChallengeToken, getHttpChallengeDebug, provisionDomain, renewDomain, checkDomainStatus, listServices, createService, getServiceBySlug, listProjectServices, getProjectServiceEnvironmentVariables, getServiceTypes, getServiceTypeParameters, deleteService, getService, updateService, getServicePreviewEnvironmentVariablesMasked, getServicePreviewEnvironmentVariableNames, listServiceProjects, linkServiceToProject, unlinkServiceFromProject, getServiceEnvironmentVariables, getServiceEnvironmentVariable, startService, stopService, getFile, getIpGeolocation, listConnections, deleteConnection, activateConnection, deactivateConnection, listRepositoriesByConnection, syncRepositories, updateConnectionToken, validateConnection, listGitProviders, createGitProvider, createGithubPatProvider, createGitlabOauthProvider, createGitlabPatProvider, deleteProvider, getGitProvider, activateProvider, handleGitProviderOauthCallback, getProviderConnections, deactivateProvider, checkProviderDeletionSafety, startGitProviderOauth, deleteProviderSafely, discoverWorkloads, executeImport, createPlan, listSources, getImportStatus, getIncident, updateIncidentStatus, getIncidentUpdates, listRoutes, createRoute, deleteRoute, getRoute, updateRoute, logout, deleteMonitor, getMonitor, getBucketedStatus, getCurrentMonitorStatus, getUptimeHistory, deletePreferences, getPreferences, updatePreferences, listNotificationProviders, createNotificationProvider, createEmailProvider, updateEmailProvider, createSlackProvider, updateSlackProvider, deleteProvider2, getNotificationProvider, updateProvider, testProvider, listOrders, getPerformanceMetrics, getMetricsOverTime, getGroupedPageMetrics, getAccessInfo, getPrivateIp, getPublicIp, getProjects, createProject, getProjectBySlug, getProjectStatistics, deleteProject, getProject, updateProject, getProjectDeployments, getLastDeployment, triggerProjectPipeline, getActiveVisitors2, getAggregatedBuckets, updateAutomaticDeploy, listCustomDomainsForProject, createCustomDomain, deleteCustomDomain, getCustomDomain, updateCustomDomain, linkCustomDomainToCertificate, getDeployment, cancelDeployment, getDeploymentJobs, pauseDeployment, resumeDeployment, rollbackToDeployment, teardownDeployment, listDsns, createDsn, getOrCreateDsn, regenerateDsn, revokeDsn, getEnvironmentVariables, createEnvironmentVariable, getEnvironmentVariableValue, deleteEnvironmentVariable, updateEnvironmentVariable, getEnvironments, createEnvironment, getEnvironment, getEnvironmentCrons, getCronById, getCronExecutions, getEnvironmentDomains, addEnvironmentDomain, deleteEnvironmentDomain, updateEnvironmentSettings, teardownEnvironment, getContainerLogs, listContainers, getContainerLogsById, getErrorDashboardStats, listErrorGroups, getErrorGroup, updateErrorGroup, listErrorEvents, getErrorEvent, getErrorStats, getErrorTimeSeries, getEventsCount2, getEventTypeBreakdown, getPropertyBreakdown, getPropertyTimeline, getEventsTimeline, getUniqueEvents, listFunnels, createFunnel, previewFunnelMetrics, deleteFunnel, updateFunnel, getFunnelMetrics, updateGitSettings, hasErrorGroups, hasAnalyticsEvents, getHourlyVisits, listIncidents, createIncident, getBucketedIncidents, listMonitors, createMonitor, updateProjectSettings, getStatusOverview, getUniqueCounts, getProxyLogs, getProxyLogByRequestId, getProxyLogById, listSyncedRepositories, getRepositoryByName, getAllRepositoriesByName, getRepositoryPresetByName, getRepositoryBranches, getRepositoryTags, getRepositoryPresetLive, getBranchesByRepositoryId, checkCommitExists, getTagsByRepositoryId, getProjectSessionReplays, getSessionEvents2, getSettings, updateSettings, getCurrentUser, listUsers, createUser, updateSelf, disableMfa, setupMfa, verifyAndEnableMfa, deleteUser, updateUser, restoreUser, assignRole, removeRole, getVisitorSessions2, deleteSessionReplay, getSessionReplay, updateSessionDuration, getSessionReplayEvents, addEvents, listAuditLogs, getAuditLog, getRequestLogs, getRequestLogById } from '../sdk.gen';
...
export const getRequestLogsQueryKey = (options?: Options<GetRequestLogsData>) => createQueryKey('getRequestLogs', options);

export const getRequestLogsOptions = (options?: Options<GetRequestLogsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getRequestLogsQueryKey(options)
    });
};

export const getRequestLogsInfiniteQueryKey = (options?: Options<GetRequestLogsData>): QueryKey<Options<GetRequestLogsData>> => createQueryKey('getRequestLogs', options, true);

export const getRequestLogsInfiniteOptions = (options?: Options<GetRequestLogsData>) => {
    return infiniteQueryOptions<GetRequestLogsResponse, DefaultError, InfiniteData<GetRequestLogsResponse>, QueryKey<Options<GetRequestLogsData>>, number | Pick<QueryKey<Options<GetRequestLogsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<GetRequestLogsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: getRequestLogsInfiniteQueryKey(options)
    });
};

export const getRequestLogByIdQueryKey = (options: Options<GetRequestLogByIdData>) => createQueryKey('getRequestLogById', options);

export const getRequestLogByIdOptions = (options: Options<GetRequestLogByIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getRequestLogById({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getRequestLogByIdQueryKey(options)
    });
};
