...
export const startOidcLoginQueryKey = (options: Options<StartOidcLoginData>) => createQueryKey('startOidcLogin', options);

export const startOidcLoginOptions = (options: Options<StartOidcLoginData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: startOidcLoginQueryKey(options)
    });
};
