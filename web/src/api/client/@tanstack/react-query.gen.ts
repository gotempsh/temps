 ...
 */
export const setPreviewEnvironmentMutation = (options?: Partial<Options<SetPreviewEnvironmentData>>): UseMutationOptions<unknown, DefaultError, Options<SetPreviewEnvironmentData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<SetPreviewEnvironmentData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await setPreviewEnvironment({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
