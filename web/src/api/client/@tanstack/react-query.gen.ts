 ...
 */
export const scrubAuditLogsMutation = (options?: Partial<Options<ScrubAuditLogsData>>): UseMutationOptions<ScrubAuditLogsResponse, DefaultError, Options<ScrubAuditLogsData>> => {
    const mutationOptions: UseMutationOptions<ScrubAuditLogsResponse, DefaultError, Options<ScrubAuditLogsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await scrubAuditLogs({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
