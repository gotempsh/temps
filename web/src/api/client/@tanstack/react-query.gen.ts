...
export const listCustomRolesQueryKey = (options?: Options<ListCustomRolesData>) => createQueryKey('listCustomRoles', options);

export const listCustomRolesOptions = (options?: Options<ListCustomRolesData>) => queryOptions<ListCustomRolesResponse, DefaultError, ListCustomRolesResponse, ReturnType<typeof listCustomRolesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: listCustomRolesQueryKey(options)
});

export const listCustomRolesInfiniteQueryKey = (options?: Options<ListCustomRolesData>): QueryKey<Options<ListCustomRolesData>> => createQueryKey('listCustomRoles', options, true);

export const listCustomRolesInfiniteOptions = (options?: Options<ListCustomRolesData>) => {
    const opts = infiniteQueryOptions<ListCustomRolesResponse, DefaultError, InfiniteData<ListCustomRolesResponse>, QueryKey<Options<ListCustomRolesData>>, number | Pick<QueryKey<Options<ListCustomRolesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListCustomRolesData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    page: pageParam
                }
            };
        ...
        queryKey: listCustomRolesInfiniteQueryKey(options)
    });
    return opts as Omit<typeof opts, 'initialData'>;
};

export const createCustomRoleMutation = (options?: Partial<Options<CreateCustomRoleData>>): UseMutationOptions<CreateCustomRoleResponse, DefaultError, Options<CreateCustomRoleData>> => {
    const mutationOptions: UseMutationOptions<CreateCustomRoleResponse, DefaultError, Options<CreateCustomRoleData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await createCustomRole({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const deleteCustomRoleMutation = (options?: Partial<Options<DeleteCustomRoleData>>): UseMutationOptions<DeleteCustomRoleResponse, DefaultError, Options<DeleteCustomRoleData>> => {
    const mutationOptions: UseMutationOptions<DeleteCustomRoleResponse, DefaultError, Options<DeleteCustomRoleData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteCustomRole({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getCustomRoleQueryKey = (options: Options<GetCustomRoleData>) => createQueryKey('getCustomRole', options);

export const getCustomRoleOptions = (options: Options<GetCustomRoleData>) => queryOptions<GetCustomRoleResponse, DefaultError, GetCustomRoleResponse, ReturnType<typeof getCustomRoleQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getCustomRole({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getCustomRoleQueryKey(options)
});

export const updateCustomRoleMutation = (options?: Partial<Options<UpdateCustomRoleData>>): UseMutationOptions<UpdateCustomRoleResponse, DefaultError, Options<UpdateCustomRoleData>> => {
    const mutationOptions: UseMutationOptions<UpdateCustomRoleResponse, DefaultError, Options<UpdateCustomRoleData>> = {
        mutationFn: async (fnOptions) => {
