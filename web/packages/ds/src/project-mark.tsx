...
export function ProjectMark({
  ...
  if (icon && !broken) {
    return (
      <img
        ...
        className={cn(
          'shrink-0 border bg-background object-contain',
          box,
          className
        )}
      />
  ...
  return (
    <span
      aria-hidden
      className={cn(
        'inline-flex shrink-0 items-center justify-center border bg-background font-mono font-medium leading-none text-foreground',
        box,
        className
      )}
    >
