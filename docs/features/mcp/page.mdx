...
The MCP server exposes **224 tools** across 30 categories, covering the full Temps API. You can [filter which categories are loaded](#tool-category-filtering) to reduce context size. The following table summarises the key categories:
