...
<Note>
  When rate limiting is configured at multiple levels, allowlist and blocklist
...
| Rate limit allowlist IPs | Additive (merged across all levels)                      |
| Rate limit blocklist IPs | Additive (merged across all levels)                      |
