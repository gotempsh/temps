...
- A **random instance ID** generated on your server (`~/.temps/anonymous_id`, or for stateless control planes a random value stored once in your database and shared by every replica) — not derived from your hardware, domain, account, or instance name
