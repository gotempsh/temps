...
- **Login Rate Limiting** - Repeated failed attempts from an IP are throttled on login, password-reset, and MFA-verification endpoints to slow down brute-force attempts
